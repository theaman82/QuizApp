...
<body class="bg-[#F6F4F0]">
    ...
    <div class="h-[650px] relative w-full">
        ...
        <div
            class="absolute flex flex-col justify-center items-center right-10 top-10 bg-[#F6F4F0] p-8 rounded-lg shadow-2xl w-[550px]">
            ...
            <form action="" method="post" class="flex flex-col gap-4 w-full">
                <input type="text" name="name"
                    class="border border-gray-400 px-4 py-2 rounded-md focus:ring-2 focus:ring-bg-[#2E5077] w-full"
                ...
                <button type="submit" name="submit"
                    class="bg-[#172e47] cursor-pointer text-white font-semibold px-4 py-2 rounded-md hover:bg-[#2E5077] transition w-full">
                    Sign Up
                </button>
            </form>
        </div>
