<div class="mb-4">
    <ul class="flex flex-wrap ml-4 -mb-px text-md font-medium text-center" id="default-tab"
        ...
        <li class="me-2" role="presentation">
            <button
                class="inline-block p-4 border-b-2 rounded-t-lg hover:text-red-600 hover:border-red-300 dark:hover:text-red-400"
                id="signout-tab" data-tabs-target="#signout" type="button" role="tab" aria-controls="signout"
                aria-selected="false">SingOut</button>
        </li>
        <form action="" method="get">
            <input type="search" name="seacrh" placeholder="Enter Tage"
                class="inline-block py-2 mt-2 text-gray-600 border-gray-600 px-4 border rounded ">
            <input type="submit" name="go" value="search"
                class="py-2 px-4 bg-black text-white font-semibold rounded text-md">
        </form>
    </ul>
</div>

<div id="default-tab-content">
    <div class="hidden p-4 rounded-lg bg-red-200 shadow-xl flex justify-center items-center m-20" id="profile"
        role="tabpanel" aria-labelledby="profile-tab">

    </div>
    <div class="hidden p-6 rounded-lg bg-white shadow-xl flex justify-center items-center m-20" id="dashboard"
                ...
                while ($quiz = $callingQuiz->fetch_array()):
                    ...
                    <tbody>
                        ...
                        <td class="border py-2 px-4 text-center">
                            <?= $quiz['total_question'] * $quiz['right_answer_marks']; ?></td>
                        <td class="border py-2 px-4 text-center">
    ...
    <div class="hidden p-4 rounded-lg shadow-xl flex justify-center items-center m-20" id="settings" role="tabpanel"
    ...
    <div class="hidden p-4 rounded-lg shadow-xl flex justify-center items-center m-20" id="contacts" role="tabpanel"
    ...
    <div class="hidden p-4 rounded-lg bg-red-200 shadow-xl flex justify-center items-center m-20" id="signout"
        role="tabpanel" aria-labelledby="signout-tab">
        <p class="text-sm text-red-600 dark:text-red-300">You're about to <strong class="font-medium">sign out</strong>.
            Click here to confirm or cancel.</p>
    </div>
    <div class="hidden p-4 rounded-lg bg-red-200 shadow-xl flex justify-center items-center m-20" id="ranking"
        role="tabpanel" aria-labelledby="ranking-tab">
        <p class="text-sm text-blue-600 dark:text-blue-300">This section displays the <strong
                class="font-medium">ranking</strong> information of users.</p>
    </div>
</div>